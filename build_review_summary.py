...
def make_markdown(cases, report_json):
    ...
    lines.append("")
    lines.append("> ВАЖНО: этот отчёт может содержать сведения о структуре документа и чувствительных кейсах. Не отправлять внешним сервисам и не публиковать без проверки.")
    lines.append("")
