...
- `limitations.md` - detection, DOCX, PDF and safety limitations.
- `supported_entities.md` - experimental entity coverage.
- `token_dictionary_security.md` - why the token dictionary is sensitive.
- `token_dictionary_storage_boundary.md` - sensitive token-dictionary storage boundary notes; no protected storage feature is currently provided or publicly committed.
...
The current MVP uses plaintext token dictionaries. No protected dictionary storage feature is currently provided or publicly committed.
