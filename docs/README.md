...
Local HTML review reports are generated under ignored `output/reports/review_report_*.html` during the demo/workflow. Treat them as sensitive local artifacts when based on real documents.
